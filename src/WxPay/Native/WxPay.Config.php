...
* 
**/
use birksCha\Lib\WxPayConfigInterface;
...
class WxPayConfig extends WxPayConfigInterface
{
    ...
    public function __construct($config)
    {
        ...
        $this->SetapiclientCert($config['apiclientCert']);
        $this->SetapiclientKey($config['apiclientKey']);
    }
    ...
    {
        $this->apiclient_cert = $value;
    }
    public function SetapiclientKey($value)
    {
        $this->apiclient_key = $value;
    }
