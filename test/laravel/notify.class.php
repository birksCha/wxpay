...
class PayNotifyCallBack extends WxPayNotify
{
	...
	**/
	...
	{
		Log::DEBUG("call back， return xml online test!:" . $xmlData);
		return;
	}
	...
	public function NotifyProcess($objData, $config, &$msg)
	{
		...
		//TODO 3、处理业务逻辑
		Log::DEBUG("call back use test:" . json_encode($data));
		$notfiyOutput = array();
		file_put_contents(__DIR__."/logs/".date('Y-m-d').'.txt',"TODO 3、处理业务逻辑\n",FILE_APPEND);
